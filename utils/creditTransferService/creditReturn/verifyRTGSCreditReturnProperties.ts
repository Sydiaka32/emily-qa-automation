...
/**
 * Verifies specific RTGS credit return properties
 */
export function verifyRTGSCreditReturnProperties(
  creditReturn: any,
  ...
  console.log("RTGS credit return specific properties verified successfully");
}
